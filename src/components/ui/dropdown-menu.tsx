...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-[11rem] overflow-hidden rounded-2xl border border-white/10 bg-canvas-raised/95 p-1.5 text-ink shadow-tile backdrop-blur-xl',
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      'px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.16em] text-ink-faint',
      className,
    )}
    {...props}
  />
